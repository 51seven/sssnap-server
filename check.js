...
// Here all required environment variables will be
// checked.
// The server will be forced to exit if something
// is missing.

var error = false;
var reason = "";

if (!process.env.GOOGLE_CLIENT_ID || !process.env.GOOGLE_CLIENT_KEY) {
